package com.challengerstory.chattingstory.user.auth.response;
...
import com.challengerstory.chattingstory.user.auth.aggregate.dto.normal.NormalLoginResponseDTO;

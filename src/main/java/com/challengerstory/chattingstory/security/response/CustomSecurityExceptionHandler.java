...
public class CustomSecurityExceptionHandler {
    ...
    public static void handleAuthenticationException(HttpServletResponse response, ErrorCode errorCode) throws IOException {
    ...
    private static void sendJsonResponse(HttpServletResponse response, HttpStatus status, Object body) throws IOException {
